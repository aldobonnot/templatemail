...
if($_GET){extract($_GET);}else{$idc="";}
if($_POST){extract($_POST);}else{$nom="";$fichiercv="";$fichiermail ="";$fichierpdf="";$fichierweb="";$titrecv="";$editor1="";$submit="";}
...
<body style="margin-top:-20px;" >
    <?php include('nav.php');?>
    <div style='text-align:center'><h1>Ajout Cv</h1></div>

    <div class="global2"> 
<form method="post" action="" enctype="multipart/form-data">
    <div class="form-group">
<label for="nom">Nom du Cv</label>
<input type="text" name="nom" id="nom" placeholder="nom du cv" class="form-control">
</div>
        
        <div class="form-group">
<label for="fichiercv">Fichier du cv sur le web</label>
<input type="text" name="fichiercv" id="fichiercv" placeholder="fichier.php" class="form-control">
</div>
        
        <div class="form-group">
<label for="fichiermail">Fichier du template mail(pour l'envoi)</label>
<input type="text" name="fichiermail" id="fichiermail" placeholder="fichier.php" class="form-control">
</div>
        
        <div class="form-group">
<label for="fichierpdf">Le cv.pdf</label>
<input type="text" name="fichierpdf" id="fichierpdf" placeholder="fichier.pdf" class="form-control">
</div>

<div class="form-group">
<label for="fichierweb">Fichier visialisation du mail sur le web</label>
<input type="text" name="fichierweb" id="fichierweb" placeholder="fichier.php" class="form-control">
</div>
        
<div class="form-group">
<label for="titrecv">Titre du cv</label>
<input type="text" name="titrecv" id="titrecv" placeholder="Ex: Compétences" class="form-control">
</div>
