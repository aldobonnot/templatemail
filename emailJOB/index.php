...
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
   ...
   .tab th:nth-child(1){width:4%;font-size:11px;}

.tab th:nth-child(2){width:35%;font-size:11px;}
.tab th:nth-child(3){width:10%;font-size:11px;}
.tab th:nth-child(4){width:15%;font-size:11px;}
.tab th:nth-child(5){width:10%;font-size:11px;}
.tab th:nth-child(6){width:10%;font-size:11px;}
.tab th:nth-child(7){width:10%;font-size:11px;}
...
echo"<table class=\"tbsql\"> 
    <tr>
        ...
        <td width=\"10%\"><img src=\"img/flecheH2.png\" id=\"$id\" onclick=\"newslq(this.id);\" class=\"bts1\"></td>
        
    </tr>
    <tr>
        <td width=\"10%\"><img src=\"img/flechB.png\" id=\"$id2\" onclick=\"newslq(this.id);\" class=\"bts2\"></td>
        <td></td>
    </tr>
    </table>";
}
?>
    <table class="tab "><tr><th><div class="thh midlle">Date</div></th><th><div class="thh midlle"><?php  butonsql("Objet",3,4);?></div></th><th><div class="thh">Variable<br>Domaine<br>CV</div></th><th>
                <div class="thh"><?php  butonsql("Email de contact",1,2);?></div></th><th><div class="thh midlle">Nom du contact </div></th><th><div class="thh midlle">Entreprise</div></th><th><div class="thh midlle">Activite</div></th></tr></table>
     <table class="tab mrgtop" id="ici"><?php
...
<script>function newslq(str){	
if(str === ""){}else
{$(document).ready(function() 
{
$.post( 'result.php', { name: str },function(data){$('#ici').html(data);
});
});
}
}</script>
