...
$appelD = new Domaine();
$resultDom = $appelD->findomaine($idD);

if($submit=="Enregister"){
	$lien = new Domaine();
        $lien->setId_dom(intval($id));
...
<body style="margin-top:-20px;" >
    <?php include('nav.php');?>
    <div style='text-align:center'><h1>Modifier le Domaine <?php echo $resultDom['slogan1'];?></h1></div>
...
foreach ($resultCv as $key => $value) {?>
    <option value="<?php echo $value['id_cv'];?>" <?php if (!(strcmp("".$resultDom['idcv']."", $value['id_cv']))) {echo "SELECTED";} ?>><?php echo $value['nom'];?></option>
...
<input type="text" name="slogan1" id="slogan1" placeholder="Intégrateur web" class="form-control" value="<?php echo $resultDom['slogan1'];?>">
</div>
        
<div class="form-group">
<label for="objet">Slogan2</label>
<input type="text" name="slogan2" id="slogan2" placeholder="Responsive Design" class="form-control" value="<?php echo $resultDom['slogan2'];?>">
</div>
        
<div class="form-group">
<label for="objet">Slogan3</label>
<input type="text" name="slogan3" id="slogan3" placeholder="Sites Web, Templates email" class="form-control" value="<?php echo $resultDom['slogan3'];?>">
</div>

<div class="form-group">
    <input type="hidden" name="id" value="<?php echo $resultDom['id_dom'];?>">
