...
if(!isset($_POST['mail'])) $mail=""; else $mail=$_POST['mail'];
...
<style type=\"text/css\">
	...
	.trois{width:95%;min-height:150px;6margin:auto;padding:6px;background:#5587a2;-moz-border-radius: 6px 6px 6px 6px;
                                ...
                                <td class=\"w640\"  width=\"640\">
                                     <table class=\"w640\"  width=\"640\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"background:#5587a2;\">
                                             <tbody>
                                                            ...
                                                            <tr>
                                                                <td class=\"w180\"  width=\"180\" >
                                                                    <div  class=\"foot1\" style=\"padding:4px;color:#ffffff;\"><hr class=\"br\">
...
<td><div class=\"cvwhite\"><a style=\"color:#f4400; font-size:12px;text-decoration:none\"  href=\"$cv\" target=\"_blank\" ><span style=\"color:#f4400; font-size:12px;text-decoration:none\">CV en ligne complet</span></a></td></tr><tr>
<td><div class=\"cvwhite\"><a style=\"color:#f4400; font-size:12px;text-decoration:none\"  href=\"$cvpdf\" target=\"_blank\" ><span style=\"color:#f4400; font-size:12px;text-decoration:none\">CV PDF</span></a></td></tr></table>																		
																		<hr class=\"br\">
                                                                    </div>
                                                                </td>
                                                            </tr>
...
$oui="Y";
$req=$mysqli->query("SELECT id_lemail, emailcontact FROM lmjob  WHERE envoi='$oui'");
...
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	...
	.oneital{font-family: Tohoma, Arial, Helvetica, Geneva, sans-serif; font-size:20px;color:#ffffff;font-style:italic;} 
	.two{font-family: Tohoma, Arial, Helvetica, Geneva, sans-serif; font-size:14px;color:#0c4c8a;} 
	.trois{width:95%;min-height:150px;margin:auto;padding:6px;background:#5587a2;-moz-border-radius: 6px 6px 6px 6px;
    -webkit-border-radius: 6px;
    border-radius: 6px 6px 6px 6px;color:#ffffff;}
	.etoile{padding-left:5px;font-size:16px;color:#FAAC58}
	.etoilea{padding-left:5px;font-size:14px;color:#B43104}
	...
	.article-content2{font-size:12px;color:#0c4c8a;}
	.article-content3{font-size:14px;}
	.h4{margin: 0px; padding: 1px 0px 1px 0px;  color:#0c4c8a;font-size:13px;font-weight:bold;}
	.br{display:none;}
	.foot1{text-align:left;}
        .cvwhite{margin:2px;padding:2px;background:#ffffff;-moz-border-radius: 6px 6px 6px 6px; -webkit-border-radius: 6px;
    border-radius: 6px 6px 6px 6px;color:#0c4c8a;text-align:center;}
    @media only screen and (max-width: 480px) { 
...
<div class="quatre">
	...
	<input name="mail" type="hidden"  value="okmail">
	<input name="iddelatemplate" type="hidden"  value="<?php echo $lidtemplate;?>"></form></td></tr>
	</table>
